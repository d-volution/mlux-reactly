...
from mlux_reactly.tools import CalculatorTool, TextCountTool
...
agent = ReactlyAgent(llm = llm, tools=[CalculatorTool(), TextCountTool()], recorder=Recorder(file=open("reactly_query_record.jsonl", "+a")))
